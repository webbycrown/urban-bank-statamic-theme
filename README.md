...
- Escape visitor-submitted fields in notification emails with the entities modifier (via the fields loop, avoiding a clash with Laravel’s Mail Message object)
